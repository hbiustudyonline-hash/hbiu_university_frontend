...
Click "Join Meeting" to participate in the live session.`,
  ...
  // Mock scheduled classes data
  const mockScheduledClasses = [
    {
      id: 1,
      title: 'Week 1 Part 2 Public Speaking and Communication',
      courseCode: 'GEN 106',
      courseName: 'Public Speaking and Communication (BA)',
      date: 'February 3rd, 2026',
      meetingLink: 'https://meet.jit.si/HBI-695d4d68-177012843514',
      status: 'Scheduled'
    },
    {
      id: 2,
      ...
      date: 'February 3rd, 2026',
      meetingLink: 'https://meet.jit.si/HBI-695d7277-177011067735',
      status: 'Scheduled'
    },
    {
      id: 3,
      title: 'Week 1',
      courseCode: 'BUS 701',
      courseName: 'Advanced Theories in the Field of Business Administration',
      date: 'February 3rd, 2026',
      meetingLink: 'https://meet.jit.si/HBI-advanced-theories-001',
      status: 'Scheduled'
    }
  ];
        ...
        <CardContent>
          {mockScheduledClasses.length === 0 ? (
            ...
            <div className="space-y-3">
              {mockScheduledClasses.map((liveClass) => {
                return (
                  <div key={liveClass.id} className="p-4 bg-gray-50 border border-gray-200 rounded-lg hover:bg-gray-100 transition-colors">
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <h4 className="font-semibold text-gray-900 mb-1">{liveClass.title}</h4>
                        <p className="text-sm text-gray-600 mb-2">
                          {liveClass.courseCode} - {liveClass.courseName}
                        </p>
                    ...
                    <div className="flex items-center gap-2 mt-3">
                      <div className="flex-1 p-2 bg-white rounded border border-gray-300 font-mono text-xs break-all text-gray-700">
                        {liveClass.meetingLink}
                      </div>
                      <Button
                        size="sm"
                        variant="outline"
                        onClick={() => copyMeetingLink(liveClass.meetingLink)}
                        className="flex-shrink-0"
                      >
                        {copiedLink === liveClass.meetingLink ? (
                          <>
