        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 p-8 md:p-12 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-purple-100 text-lg">
                Central administration and management portal
              </p>
            </div>
          </div>
          ...
          <Card className="shadow-lg">
            <CardHeader className="bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-t-lg">
              <CardTitle>Virtual Admin Office</CardTitle>
            </CardHeader>
            <CardContent className="pt-6">
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                <div className="space-y-3">
                  <Building2 className="w-12 h-12 text-gray-400 mx-auto" />
                  <p className="text-gray-500 font-semibold">Admin Office</p>
                  <p className="text-gray-400 text-sm">Administrative tools and management options will appear here</p>
                </div>
              </div>
            </CardContent>
          </Card>
