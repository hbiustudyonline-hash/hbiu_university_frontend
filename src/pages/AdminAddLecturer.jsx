...
export default function AdminAddLecturer() {
  return (
    <Layout currentPageName="AdminAddLecturer">
          ...
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 p-8 md:p-12 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-purple-100 text-lg">
                Manage and add new lecturers to the system
              </p>
            </div>
          </div>
            ...
            <CardContent className="pt-6">
              <div className="border-2 border-dashed border-gray-300 rounded-lg p-12 text-center">
                <div className="space-y-3">
                  ...
                  <p className="text-gray-500 font-semibold">Add New Lecturer</p>
                  <p className="text-gray-400 text-sm">Add new lecturers to the system here</p>
                </div>
              </div>
            </CardContent>
          </Card>
